...
The axe audit uses WCAG 2 A/AA, 2.1 A/AA and 2.2 AA tagged rules on Home, Work, Contact and Components. It checks all four palettes at 390 px and ocean at 1440 px. The local Compose demo passed those automated checks on 23 September 2026. CI reruns them against a fresh starter installation. The contact form was submitted locally and its message was found in Mailpit.
