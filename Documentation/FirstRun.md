...
4. **Mail:** Configure TYPO3's mail transport for the deployment. Send a real test inquiry and confirm delivery and reply-to behavior. The included Compose setup uses Mailpit only for local testing.
